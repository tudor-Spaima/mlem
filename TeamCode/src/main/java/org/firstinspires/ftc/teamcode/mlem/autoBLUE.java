...
public class autoBLUE extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence colectar = drive.trajectorySequenceBuilder(preload.end())
                .lineToLinearHeading(new Pose2d( -15,  -53.97938996093803 , Math.toRadians(180
                )) )
        ...
        TrajectorySequence score3 = drive.trajectorySequenceBuilder(inter1.end())
                .lineToLinearHeading(new Pose2d( 68, -22, Math.toRadians(180
                )) )
        ...
        TrajectorySequence inter2 = drive.trajectorySequenceBuilder(score3.end())
                .lineToLinearHeading(new Pose2d( 33.98596961335462, -54, Math.toRadians(180
                )) )
        ...
        TrajectorySequence colectar2 = drive.trajectorySequenceBuilder(inter2.end())
                .lineToLinearHeading(new Pose2d( -15.3,  -54.728803279177384, Math.toRadians(180
                )) )
                .addTemporalMarker(1, ()->{
        ...
        TrajectorySequence sccaorea = drive.trajectorySequenceBuilder(inter3.end())
                .lineToLinearHeading(new Pose2d( 64, -32.70182995504614, Math.toRadians(180
                )) )
                .addDisplacementMarker(()->{
